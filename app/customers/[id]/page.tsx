      ...
      <main className="flex-1 px-6 py-6 max-w-[900px] w-full mx-auto">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <span
              className={`inline-block px-3.5 py-1.5 rounded-full text-[13px] font-medium ${statusStyles[customer.status]}`}
            >
            ...
            <div className="grid grid-cols-3 gap-3.5">
              {[
                ...
                <div key={f.label} className="flex flex-col gap-0.5">
                  ...
                  <span
                    className={`text-[14px] text-ink ${f.mono ? "font-mono" : ""} ${f.highlight ? "font-medium" : ""}`}
                  >
                    {f.value}
                  </span>
                </div>
